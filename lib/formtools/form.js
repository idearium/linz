...
var generateFormFromModel = exports.generateFormFromModel = function (m, schemaFields, r, formType, cb) {
    ...
    Object.keys(schemaFields).forEach(function (fieldName) {
        ...
        // Prevent the form footer and header renderers from showing up in the form.
        if (!schemaFields[fieldName] || typeof schemaFields[fieldName] === 'function') {
            return;
        }
            ...
            function (callback) {
                ...
                if (field.transpose) {
                    ...
                    switch (field.type) {
                        ...
                        default:
                        fieldValue = (r[fieldName] !== undefined && r[fieldName] !== null ? r[fieldName].toString() : null) || ((typeof defaultValue !== 'undefined' && defaultValue !== null) ? defaultValue.toString() : defaultValue);
                        break;
